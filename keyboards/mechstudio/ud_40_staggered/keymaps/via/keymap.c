...
[0] = LAYOUT_staggered(
  ...
  KC_TAB,   KC_A,        KC_S,        KC_D,        KC_F,        KC_G,      KC_H,     KC_J,     KC_K,     KC_L,     _______,  KC_QUOT,
  KC_LSFT,  _______,     KC_Z,        KC_C,        KC_V,        KC_B,      KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_ENT,
  KC_LCTRL, MO(1),       KC_LALT,     MO(2),     _______,     _______,   KC_SPC,   _______,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT),

[1] = LAYOUT_staggered(
  KC_GRV,   KC_1,        KC_2,        KC_3,        KC_4,        KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_DEL,
  KC_TILD,  KC_F1,       KC_F2,       KC_F3,       KC_F4,       KC_F5,    KC_F6,    KC_MINS,  KC_EQL,   KC_LBRC,  KC_RBRC,  KC_BSLS,
  KC_F7,    _______,     KC_F8,       KC_F9,       KC_F10,      KC_F11,   KC_F12,   _______,  _______,  KC_PGUP,  KC_PGDN,  _______,
