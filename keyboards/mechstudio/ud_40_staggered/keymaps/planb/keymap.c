 ...
 * ├────┬─┴─┬─┴──┬┴───┴──┬┴───┴───┴┬──┴──┬┴───┼────┤
 * │Navi│Alt│ OS │FN2Spac│ FN1Space│RAlt │    │Navi│
 * └────┴───┴────┴───────┴─────────┴─────┴────┴────┘
*/
[_BASE] = LAYOUT_staggered(
  ...
  MO(_NAV), KC_LALT, KC_LGUI,   LT_FN2_SPACE,   LT_FN1_SPACE, LT_FN1_SPACE,     KC_RALT,     _______, MO(_NAV)
),
...
layer_state_t layer_state_set_user(layer_state_t state) {
  return update_tri_layer_state(state, _FN1, _FN2, _TRI);
}


/* TEMPLATE STAGGERED SPLIT SPACE
 * ┌───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┐
 * │   │   │   │   │   │   │   │   │   │   │   │   │
 * ├───┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴───┤
 * │    │   │   │   │   │   │   │   │   │   │      │
